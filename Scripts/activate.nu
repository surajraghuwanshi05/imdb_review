...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Lenovo\PycharmProjects\tindog_start_here'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Lenovo\PycharmProjects\tindog_start_here\Scripts\deactivate.nu'
